      ...
      <div className="w-full bg-brand-bg transition-all duration-500">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 xl:gap-24 items-center">
              ...
              <div className="lg:col-span-6 space-y-6 sm:space-y-8 text-left animate-fade-in animate-duration-500">
                ...
                <p className="text-brand-muted text-xs sm:text-sm md:text-base leading-relaxed font-serif italic max-w-lg">
                  Meticulously hand-embroidered by local artisan mothers in Malang. Blending traditional craftsmanship with the cooling restraint of organic cotton-rayon to accompany your sacred moments.
                </p>
                ...
                <div className="pt-8 border-t border-brand-accent/25">
                  <div className="grid grid-cols-3 gap-6 sm:gap-10">
                    <div>
                      <p className="font-serif text-3xl sm:text-4xl text-brand-primary italic font-bold leading-none">1900+</p>
                      <p className="text-[10px] uppercase tracking-widest text-brand-muted font-sans font-bold mt-1.5">Pieces Sold</p>
                    </div>
                    <div>
                      <p className="font-serif text-3xl sm:text-4xl text-brand-primary italic font-bold leading-none">6</p>
                      <p className="text-[10px] uppercase tracking-widest text-brand-muted font-sans font-bold mt-1.5">Countries</p>
                    </div>
                    <div>
                      <p className="font-serif text-3xl sm:text-4xl text-brand-primary italic font-bold leading-none">30+</p>
                      <p className="text-[10px] uppercase tracking-widest text-brand-muted font-sans font-bold mt-1.5">Artisans</p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="absolute -bottom-4 -left-4 sm:-bottom-6 sm:-left-6 bg-brand-bg border border-brand-accent/20 p-4 rounded-[4px] shadow-xs z-20 flex items-center space-x-4 max-w-[280px]">
                    <div className="space-y-1">
                      <div className="flex items-center space-x-1.5">
                        ...
                        <span className="text-[9px] font-sans font-bold text-brand-accent uppercase tracking-[0.2em]">New Arrival</span>
                      </div>
                      <p className="font-serif text-sm font-bold text-brand-primary italic">Mukena Padi</p>
                      <p className="text-[9px] font-sans text-brand-muted uppercase tracking-wider font-bold">Handcrafted · Malang</p>
                    </div>
        ...
        <div className="w-full bg-[#5A3A3A] py-3.5 border-y border-brand-pink/20 overflow-hidden select-none flex">
          <div className="animate-marquee flex items-center whitespace-nowrap">
            {/* Set 1 */}
            {Array(4).fill(MARQUEE_ITEMS).flat().map((item, idx) => (
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
              ...
              <div className="lg:col-span-7 space-y-6 sm:space-y-8 text-left">
                ...
                {/* Serif headline: Bukan sekadar mukena, teman dalam perjalanan ibadah muslimah. */}
                ...
                {/* Two short body paragraphs about the brand story and artisan empowerment */}
                ...
                {/* 2-column mini-timeline at the bottom */}
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-6 border-t border-brand-accent/15">
                  
                  {/* Left Timeline item */}
                  <div className="border-l-2 border-[#C48A8F] pl-4 py-1 space-y-1">
                    <p className="font-serif text-lg font-bold text-brand-primary italic">2010</p>
                    <p className="text-xs text-brand-muted leading-relaxed font-sans font-medium">
                      Home-based, single founder, 10 pieces at a time.
                    </p>
                  </div>
                  
                  {/* Right Timeline item */}
                  <div className="border-l-2 border-[#C48A8F] pl-4 py-1 space-y-1">
                    <p className="font-serif text-lg font-bold text-brand-primary italic">2025</p>
                    <p className="text-xs text-brand-muted leading-relaxed font-sans font-medium">
                      Mid-scale UMKM — 4 in-house + 30 artisan partners.
                    </p>
                  </div>
        ...
        <section id="social-impact-section" className="py-24 bg-[#5A3A3A] border-b border-brand-primary/10 overflow-hidden px-4 sm:px-6 lg:px-12 text-center">
          <div className="max-w-5xl mx-auto space-y-10 animate-fade-in">
            ...
            <p className="text-brand-bg/85 text-xs sm:text-sm md:text-base leading-relaxed font-serif italic max-w-2xl mx-auto">
              Behind each meticulous stitch is an artisan mother in rural Malang, crafting her family's future with dignified dedication. Through sustainable wages, healthcare support, and flexible home-based schedules, we honor their quiet devotion and build generational resilience—one prayer at a time.
            </p>
            ...
            <div className="pt-8">
              <div className="grid grid-cols-2 lg:grid-cols-4 border border-brand-pink/20 rounded-[8px] bg-[#513333] overflow-hidden">
                ...
                {/* Stat 1 */}
                <div className="p-8 flex flex-col items-center justify-center space-y-1.5 border-r border-b lg:border-b-0 border-brand-pink/15">
                ...
                {/* Stat 2 */}
                <div className="p-8 flex flex-col items-center justify-center space-y-1.5 border-b lg:border-b-0 lg:border-r border-brand-pink/15">
                  <span className="font-serif text-4xl sm:text-5xl text-brand-surface italic font-bold leading-none select-none">
                    1900+
                  </span>
                  <span className="text-[10px] uppercase tracking-[0.15em] text-[#E8B4B8]/75 font-sans font-bold text-center">
                ...
                {/* Stat 3 */}
                <div className="p-8 flex flex-col items-center justify-center space-y-1.5 border-r border-brand-pink/15">
                  <span className="font-serif text-4xl sm:text-5xl text-brand-surface italic font-bold leading-none select-none">
                    6
                  </span>
                  <span className="text-[10px] uppercase tracking-[0.15em] text-[#E8B4B8]/75 font-sans font-bold text-center">
                ...
                {/* Stat 4 */}
                <div className="p-8 flex flex-col items-center justify-center space-y-1.5">
                  <span className="font-serif text-4xl sm:text-5xl text-brand-surface italic font-bold leading-none select-none">
                    15+
                  </span>
                  <span className="text-[10px] uppercase tracking-[0.15em] text-[#E8B4B8]/75 font-sans font-bold text-center">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
              ...
              <div className="lg:col-span-5 space-y-6">
                ...
                <p className="text-brand-muted text-xs sm:text-sm leading-relaxed font-serif text-justify italic">
                  Delicate hand-embroidery on the finest, lightweight fabric. A graceful companion for daily prayer and sacred moments, adorned with care by local skilled artisan mothers in Malang. Each single Kechally mukena is crafted using traditional techniques, ensuring that each piece is unique, beautiful, and remarkably comfortable.
                </p>
                <p className="text-brand-muted text-xs text-justify font-sans leading-relaxed">
                  Made from premium breathable cotton-rayon blend to ensure cooling comfort even in hot, tropical climates. Our pieces are tailored so you can experience tranquil, uninterrupted prayer.
                </p>
        ...
        <section id="luxury-testimonial-section" className="py-28 sm:py-36 md:py-40 bg-[#FAF0F0] text-center relative overflow-hidden flex items-center justify-center">
          <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
            ...
            <p className="font-serif text-xl sm:text-2xl md:text-3xl lg:text-[32px] italic text-brand-primary leading-relaxed sm:leading-relaxed md:leading-[1.45] font-normal tracking-wide max-w-4xl mx-auto text-center">
              I really like this product — I even use it myself often. The quality is good, it's comfortable to wear, and I feel like sharing it with everyone.
            </p>
            ...
            <div className="flex items-center justify-center space-x-4 sm:space-x-6 mt-12">
              ...
              <span className="text-[11px] sm:text-xs uppercase tracking-[0.25em] text-brand-muted font-sans font-bold whitespace-nowrap">
                — Sofia, Customer from the Netherlands
              </span>
        ...
        <section id="collaboration-cta-section" className="relative w-full bg-[#F5E0E2] py-28 sm:py-36 overflow-hidden flex flex-col items-center justify-center text-center px-4 sm:px-6 lg:px-8 border-b border-brand-primary/10 select-none">
          ...
          <div className="relative z-10 max-w-3xl mx-auto space-y-6 sm:space-y-8">
            ...
            {/* Serif headline with italic "Kechally" */}
            ...
            <p className="text-[#5A3A3A]/85 text-xs sm:text-sm md:text-base leading-relaxed font-serif italic max-w-xl mx-auto">
              We welcome resellers, dropshippers, and brand collaborations worldwide.
            </p>
